...
const ATMDashboard = () => {
  ...
  // Always render content without any Layout wrapper since routing handles it
  return (
    <div className="space-y-6">
      {getCurrentTab() === 'overview' && (
        ...
        {getCurrentTab() === 'multi-anomaly' && (
          <MultiAnomalyView />
        )}

        {getCurrentTab() === 'alerts' && (
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6">
        ...
        {getCurrentTab() === 'expert-labeling' && (
          <ExpertLabelingInterface />
        )}

        {getCurrentTab() === 'continuous-learning' && (
          <ContinuousLearningInterface />
        )}

        {getCurrentTab() === 'monitoring' && (
          <RealtimeMonitoringInterface />
        )}

        {getCurrentTab() === 'svm-debug' && (
          <SVMDebugDashboard />
        )}
