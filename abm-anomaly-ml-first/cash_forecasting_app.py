...
def visualization_data(terminal_id):
    """Get chart data for visualizations with working implementation"""
    try:
        logger.info(f"🔥 VISUALIZATION DATA REQUEST for terminal {terminal_id}")
        ...
        logger.info(f"✅ Returning visualization data for terminal {terminal_id}")
